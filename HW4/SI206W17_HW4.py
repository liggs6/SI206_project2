...
nyt_headlines = []
html = open("nytimes_data.html", "r")
file = html.read()
soup = BeautifulSoup(file, "html.parser")
for headline in soup.find_all(class_="story-heading"):
	if headline.a:
		nyt_headlines.append(headline.a.text.replace("\n", " ").strip())
	else:
		nyt_headlines.append(headline.contents[0].strip())

nytimes_headlines = nyt_headlines[0:10]
